# dashboard_rial_iranien_2025.py (CORRIGÉ)
...
# Sources: bne IntelliNews, Trend.az, Kompas 
DEMO_DATA = {
    'USDIRR': {
        'name': 'Dollar américain / Rial iranien (USD/IRR)',
        'official_rate': 1311134,  # Taux officiel Banque Centrale 
        'nima_rate': 1403083,       # Taux NIMA (système SANA) 
        'free_market_rate': 1749500, # Taux marché libre 
    ...
    'EURIRR': {
        ...
        'official_rate': 1549954,    # Taux officiel 
        'nima_rate': 1658651,        # Taux NIMA 
        'free_market_rate': 2067500,  # Taux marché libre 
    ...
    'GBPIRR': {
        ...
        'official_rate': 1764178,    # Taux officiel 
        'free_market_rate': 2353500,  # Taux marché libre 
    ...
    'AEDIRR': {
        ...
        'official_rate': 357014,     # Taux officiel 
    ...
    'SARIRR': {
        ...
        'official_rate': 349636,     # Taux officiel 
    ...
    'TRYIRR': {
        ...
        'official_rate': 29829,      # Taux officiel 
    ...
    'CNYIRR': {
        ...
        'official_rate': 191150,     # Taux officiel 
    ...
    'RUBIRR': {
        ...
        'official_rate': 16961,      # Taux officiel 
        'free_market_rate': 22650,    # Taux marché libre 
    ...
    'INRIRR': {
        ...
        'official_rate': 14400,      # Taux officiel 
    ...
    'JPYIRR': {
        'name': 'Yen japonais (100 JPY) / Rial iranien (JPY/IRR)',
        'official_rate': 84017,     # Pour 100 JPY (corrigé)
        'free_market_rate': 112000,   # Estimé (corrigé)
        'previous_close': 111000,
        'day_high': 113000,
        'day_low': 110500,
        'volume': 5000000,
    ...
    'XAUIRR': {
        ...
        'free_market_rate': 224504820,  # Prix de l'or à Téhéran 
...
<div class='sanction-note'>
    ...
    Sources: Bonbast, CBI, Trend.az, bne IntelliNews 
</div>
""", unsafe_allow_html=True)
...
<div style='background: linear-gradient(135deg, #239F40 0%, #FFFFFF 50%, #DA0000 100%); padding: 1rem; border-radius: 0.5rem; margin: 1rem 0;'>
    ...
    • Taux officiel CBI: 1 USD = 1,311,134 IRR <br>
    • Taux NIMA (SANA): 1 USD = 1,403,083 IRR <br>
    • Taux marché libre: 1 USD = 1,749,500 IRR (record historique) <br>
    • Dépréciation 2025: -45% <br>
    • Inflation annuelle: >42% <br>
    • Perte de valeur depuis 1979: x20,000 
</div>
""", unsafe_allow_html=True)
...
# ============================================================================
    ...
    if hist is not None and not hist.empty and len(hist) > 30:
        ...
        **Facteurs géopolitiques:**
        - Sanctions internationales (USA, UE, ONU) 
        ...
        **Événements récents (février 2026):**
        - Record historique: 1 USD = 1,749,500 IRR 
...
# ============================================================================
    ...
    with col_c1:
        ...
        indicators = {
            "Inflation annuelle": "42.2% (décembre 2025) ",
            "Inflation alimentaire": "60-70% ",
            "Dépréciation 2025": "-45% ",
            "Dépréciation depuis 1979": "x20,000 ",
            "Taux officiel USD": "1,311,134 IRR ",
            "Taux NIMA USD": "1,403,083 IRR ",
            "Taux marché libre USD": "1,749,500 IRR (record) ",
            "Prix de l'or (Téhéran)": "224.5 M IRR/gramme ",
            "Réserves de change": "~20-30 Mds $ (estimé)",
            "Population": "~90 millions ",
            "PIB (estimé)": "~400 Mds $",
            "Croissance PIB 2025": "-1.7% ",
            "Croissance PIB 2026 (prév.)": "-2.8% ",
        }
    ...
    with col_c2:
        ...
        st.markdown("""
        - **ONU:** Réimposition septembre 2025 
        ...
        - Admission américaine de guerre économique 
        """)
    ...
    with st.expander("📰 Sources et références"):
        st.markdown("""
        - **bne IntelliNews:** Record historique du Rial (février 2026) 
        - **Kompas:** Analyse détaillée des causes de la dépréciation 
        - **Trend.az:** Taux officiels de la Banque Centrale d'Iran 
        - **Republika:** Contexte historique depuis 1979 
        - **El Universal:** Impact social et manifestations 
        - **Dân trí:** Analyse du système de taux multiples 
        - **La Nouvelle Tribune:** Stratégie américaine de pression financière 
        - **VnEconomy:** Impact des sanctions sur les revenus pétroliers 
        """)
